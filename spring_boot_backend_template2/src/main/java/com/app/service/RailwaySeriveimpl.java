...
public class RailwaySeriveimpl implements RailwaySerivce{
   ...
   private StationDao sdao;
	...
	public String deletebyId(Long id) {
		Railway r=rdao.findById(id).orElseThrow(()->new ResouceNotFoundException("No such trians please enter valid number for deletion"));
...
Railway r=rdao.findById(r1.getId()).orElseThrow(()->new ResouceNotFoundException("No such trians please enter valid number for updation"));
